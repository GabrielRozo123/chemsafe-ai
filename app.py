...
# Módulos de Views (extraídos do app.py no Bloco A)
...
# ==============================================================================
# CONSTANTES DE MAPEAMENTO E CUSTOS
# ==============================================================================
...
def classify_hierarchy(action_text):
    ...
    if any(
        word in text
        for word in [
            "sis", "sif", "esd", "clp", "plc", "válvula", "valvula",
            "psv", "alarme", "sensor", "detector", "intertravamento", "bloqueio",
        ]
    ):
    ...
    if any(
        word in text
        for word in [
            "treinar", "treinamento", "procedimento", "instrução",
            "instrucao", "revisar", "checklist",
        ]
    ):
...
# ==============================================================================
# FUNÇÕES DE GRÁFICOS (usadas pelos módulos de views)
# ==============================================================================
